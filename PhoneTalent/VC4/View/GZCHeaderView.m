...
//  PhoneTalent
//
//  Created by gaozhichao on 2016/12/1.
...
@interface GZCHeaderView ()
    
@property (strong, nonatomic) UIImageView *imageV; //随便放一个imageView
@property (assign, nonatomic) CGFloat headerViewHeight;//headerView高度
@property (assign, nonatomic) CGFloat screenWidth;

@end

@implementation GZCHeaderView
    
- (UIImageView *)imageV {
    if (_imageV == nil) {
        _imageV = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"king2"]];
